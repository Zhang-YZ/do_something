...
rawlogPaths = [x for x in tempPaths if "_tail" in x]
rawlogInfo = {}
...
with open(csvPath,"w") as f:
    f_csv = csv.writer(f)
    row = ["algorithm","way","sourceSize","matchResultsSize","matchResults_rate","lzma","lzma_rate","gz","gz_rate","bz2","bz2_rate","7z","7z_rate","zip","zip_rate","double_lzma","double_lzma_rate","double_gz","double_gz_rate","double_bz2","double_bz2_rate","double_7z","double_7z_rate","double_zip","double_zip_rate"]
    f_csv.writerow(row)
