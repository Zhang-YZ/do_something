...
rawlogPaths = [x for x in tempPaths if ("Hadoop_tail" in x or "Linux_tail" in x)]
rawlogInfo = {}
...
for path in algPaths:
    tempLists = os.listdir(resultPath+path)
    tempList = [x for x in tempLists if ("Hadoop" in x or "Linux" in x)]
